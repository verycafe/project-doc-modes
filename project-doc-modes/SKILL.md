...
- use `/project-doc-modes-sdd` for SDD-RIPER governance
...
- write target docs as project-native governance, not as instructions to invoke `project-doc-modes`, `/project-doc-modes`, `/project-doc-modes-sdd`, `/project-doc-modes-sync`, `/project-doc-modes-verify`, `/sdd`, `$project-doc-modes`, `hooks.md`, or an installed `SKILL.md`
